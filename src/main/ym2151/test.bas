...
4010 DATA $08, $78: REM CHANNEL 0 KEY ON
4020 DATA $28, $30: REM CHANNEL 0 KEY CODE
4030 DATA $02, $20: REM PAUSE 32

4100 DATA $08, $00: REM CHANNEL 0 KEY OFF
4110 DATA $08, $78: REM CHANNEL 0 KEY ON
4120 DATA $28, $31: REM CHANNEL 0 KEY CODE
4130 DATA $02, $20: REM PAUSE 32

4200 DATA $08, $00: REM CHANNEL 0 KEY OFF
4210 DATA $08, $78: REM CHANNEL 0 KEY ON
4220 DATA $28, $32: REM CHANNEL 0 KEY CODE
4230 DATA $02, $20: REM PAUSE 32

4300 DATA $08, $00: REM CHANNEL 0 KEY OFF
4310 DATA $08, $78: REM CHANNEL 0 KEY ON
4320 DATA $28, $33: REM CHANNEL 0 KEY CODE
4330 DATA $02, $20: REM PAUSE 32

4400 DATA $08, $00: REM CHANNEL 0 KEY OFF
4410 DATA $08, $78: REM CHANNEL 0 KEY ON
4420 DATA $28, $34: REM CHANNEL 0 KEY CODE
4430 DATA $02, $20: REM PAUSE 32

4500 DATA $08, $00: REM CHANNEL 0 KEY OFF
4510 DATA $08, $78: REM CHANNEL 0 KEY ON
4520 DATA $28, $35: REM CHANNEL 0
4530 DATA $02, $20: REM PAUSE 32

4600 DATA $08, $00: REM CHANNEL 0 KEY OFF
4610 DATA $08, $78: REM CHANNEL 0 KEY ON
4620 DATA $28, $36: REM CHANNEL 0
